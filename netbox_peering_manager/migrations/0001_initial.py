    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('description', models.CharField(blank=True, max_length=200)),
                ('export_policies', models.ManyToManyField(blank=True, related_name='group_export_policies', to='netbox_peering_manager.routingpolicy')),
                ('import_policies', models.ManyToManyField(blank=True, related_name='group_import_policies', to='netbox_peering_manager.routingpolicy')),
                ('tags', taggit.managers.TaggableManager(through='extras.TaggedItem', to='extras.Tag')),
            ],
            options={
