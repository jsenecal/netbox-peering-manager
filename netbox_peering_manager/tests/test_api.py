...
class CommunityAPITestCase(
    ...
    graphql_base_name = "netbox_peering_manager_community"
...
class CommunityListAPITestCase(
    ...
    graphql_base_name = "netbox_peering_manager_communitylist"
...
class CommunityListRuleAPITestCase(
    ...
    graphql_base_name = "netbox_peering_manager_communitylist_rule"
    ...
    user_permissions = [
        "netbox_peering_manager.view_communitylist",
        "netbox_peering_manager.view_community",
    ]
...
class BGPPeerGroupAPITestCase(
    ...
    view_namespace = "plugins-api:netbox_peering_manager"
    brief_fields = ["description", "display", "id", "name", "url"]
    graphql_base_name = "netbox_peering_manager_peer_group"
...
class RoutingPolicyAPITestCase(
    ...
    view_namespace = "plugins-api:netbox_peering_manager"
    brief_fields = ["description", "display", "id", "name", "url"]
    graphql_base_name = "netbox_peering_manager_routing_policy"
...
class RoutingPolicyRuleAPITestCase(
    ...
    view_namespace = "plugins-api:netbox_peering_manager"
    brief_fields = ["description", "display", "id"]
    graphql_base_name = "netbox_peering_manager_routing_policy_rule"
...
class PrefixListRuleAPITestCase(
    ...
    view_namespace = "plugins-api:netbox_peering_manager"
    brief_fields = ["description", "display", "id"]
    graphql_base_name = "netbox_peering_manager_prefixlist_rule"

    user_permissions = [
        "netbox_peering_manager.view_prefixlist",
    ]
