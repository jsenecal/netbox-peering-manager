...
class BGPPeerGroupTable(NetBoxTable):
    ...
    tags = TagColumn(url_name="plugins:netbox_peering_manager:peer_group_list")

    class Meta(NetBoxTable.Meta):
        model = BGPPeerGroup
        fields = ("pk", "name", "description", "tags", "import_policies", "export_policies")
...
class RoutingPolicyRuleTable(NetBoxTable):
    ...
    class Meta(NetBoxTable.Meta):
        ...
        fields = ("pk", "routing_policy", "index", "match_statements", "set_statements", "action", "description")
