...
class NetBoxBGPASPathListRuleFilter(NetBoxModelFilterMixin):
    ...
    aspath_list: (
        Annotated[
            "NetBoxBGPASPathListFilter", strawberry.lazy("netbox_peering_manager.graphql.filters")
        ]
        | None
    ...
    action: (
        Annotated[
            "NetBoxBGPActionEnum", strawberry.lazy("netbox_peering_manager.graphql.enums")
        ]
        | None
    ) = strawberry_django.filter_field()
...
class NetBoxBGPCommunityFilter(TenancyFilterMixin, NetBoxModelFilterMixin):
    ...
    status: (
        Annotated[
            "NetBoxBGPCommunityStatusEnum", strawberry.lazy("netbox_peering_manager.graphql.enums")
        ]
        | None
    ) = strawberry_django.filter_field()
...
class NetBoxBGPSessionFilter(TenancyFilterMixin, NetBoxModelFilterMixin):
    ...
    status: (
        Annotated[
            "NetBoxBGPSessionStatusEnum", strawberry.lazy("netbox_peering_manager.graphql.enums")
        ]
        | None
    ) = strawberry_django.filter_field()
    ...
    peer_group: (
        Annotated[
            "NetBoxBGPBGPPeerGroupFilter", strawberry.lazy("netbox_peering_manager.graphql.filters")
        ]
        | None
    ) = strawberry_django.filter_field()
    ...
    import_policies: (
        Annotated[
            "NetBoxBGPRoutingPolicyFilter", strawberry.lazy("netbox_peering_manager.graphql.filters")
        ]
        | None
    ) = strawberry_django.filter_field()
...
class NetBoxBGPPrefixListFilter(NetBoxModelFilterMixin):
    ...
    family: (
        Annotated[
            "NetBoxBGPIPAddressFamilyEnum", strawberry.lazy("netbox_peering_manager.graphql.enums")
        ]
        | None
    ) = strawberry_django.filter_field()
...
class NetBoxBGPPrefixListRuleFilter(NetBoxModelFilterMixin):
    ...
    prefix_list: (
        Annotated[
            "NetBoxBGPPrefixListFilter", strawberry.lazy("netbox_peering_manager.graphql.filters")
        ]
        | None
    ) = strawberry_django.filter_field()
...
class NetBoxBGPCommunityListRuleFilter(NetBoxModelFilterMixin):
    ...
    community_list: (
        Annotated[
            "NetBoxBGPCommunityListFilter", strawberry.lazy("netbox_peering_manager.graphql.filters")
        ]
        | None
    ) = strawberry_django.filter_field()
